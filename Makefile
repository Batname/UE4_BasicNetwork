...
MyNet-Linux-Debug:
	 $(PROJECTBUILD) MyNet Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyNet-Linux-DebugGame:
	 $(PROJECTBUILD) MyNet Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyNet-Linux-Shipping:
	 $(PROJECTBUILD) MyNet Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyNet-Linux-Test:
	 $(PROJECTBUILD) MyNet Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyNet:
	 $(PROJECTBUILD) MyNet Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyNetEditor-Linux-Debug:
	 $(PROJECTBUILD) MyNetEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyNetEditor-Linux-DebugGame:
	 $(PROJECTBUILD) MyNetEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyNetEditor-Linux-Shipping:
	 $(PROJECTBUILD) MyNetEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyNetEditor-Linux-Test:
	 $(PROJECTBUILD) MyNetEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyNetEditor:
	 $(PROJECTBUILD) MyNetEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
