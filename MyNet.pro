...
unrealRootPath=/home/bat/Apps/UnrealEngine
MyNetRootPath=/media/bat/SecondSSD/Projects/Unreal/MyNet

gameProjectFile=/media/bat/SecondSSD/Projects/Unreal/MyNet/MyNet.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(MyNetSource.pri)
include(MyNetHeader.pri)
include(MyNetConfig.pri)
include(MyNetIncludes.pri)
include(MyNetDefines.pri)
...
MyNet-Linux-Debug.commands = $$build MyNet Linux Debug  -project="\"$$gameProjectFile\"" $$args
MyNet-Linux-DebugGame.commands = $$build MyNet Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MyNet-Linux-Shipping.commands = $$build MyNet Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MyNet-Linux-Test.commands = $$build MyNet Linux Test  -project="\"$$gameProjectFile\"" $$args
MyNet.commands = $$build MyNet Linux Development  -project="\"$$gameProjectFile\"" $$args

MyNetEditor-Linux-Debug.commands = $$build MyNetEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
MyNetEditor-Linux-DebugGame.commands = $$build MyNetEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MyNetEditor-Linux-Shipping.commands = $$build MyNetEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MyNetEditor-Linux-Test.commands = $$build MyNetEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
MyNetEditor.commands = $$build MyNetEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	MyNet-Linux-Debug \
	MyNet-Linux-DebugGame \
	MyNet-Linux-Shipping \
	MyNet-Linux-Test \
	MyNet \
	MyNetEditor-Linux-Debug \
	MyNetEditor-Linux-DebugGame \
	MyNetEditor-Linux-Shipping \
	MyNetEditor-Linux-Test \
	MyNetEditor \
